        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanDue = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Loans_Magazines_MagazineId",
                        column: x => x.MagazineId,
                        principalTable: "Magazines",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Loans_Newspapers_NewspaperId",
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "AuthorId", "CheckedOut", "DueDate", "Genre", "LibrarianId", "PageCount", "Title" },
                values: new object[,]
                {
                    { 1, 2, false, null, "Romance", "lib123", 432, "Pride and Prejudice" },
                    { 2, 1, false, null, "Programming", "lib123", 900, "C# in Depth" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loans_MagazineId",
                table: "Loans",
                column: "MagazineId");

            migrationBuilder.CreateIndex(
                name: "IX_Loans_NewspaperId",
                table: "Loans",
                column: "NewspaperId");
        }
